...
export default {
    ...
    methods: {
        ...
        startChat() {
            this.socket = new WebSocket(`wss://easyhelp.kz/ws/messanger/open-chat/${this.newId}`);
...
<script setup>
useSeoMeta({
    title: 'Мессенджер | EasyHelp',
    ogTitle: 'Мессенджер | EasyHelp',
    description: 'Мессенджер | EasyHelp',
    ogDescription: 'Мессенджер | EasyHelp',
})
</script>
