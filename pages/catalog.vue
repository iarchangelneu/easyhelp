    ...
    <div class="catalog">
        ...
        <div class="filters">
            <div class="input-group">
                <input type="text" class="form-control" placeholder="Поиск" aria-label="search" v-model="search"
                    @input="searchProducts" aria-describedby="basic-addon1">
            ...
            <div class="buttons">
                ...
                <div class="sort__body" :class="{ activeFilt: sort }">
                    <h3 @click="activeSort = 1, sortBy('price')" :class="{ activeSpan: activeSort == 1 }">Сначала дешевле
                    </h3>
                    <h3 @click="activeSort = 2, sortBy('-price')" :class="{ activeSpan: activeSort == 2 }">Сначала дороже
                    </h3>
                    <h3 @click="activeSort = 3, sortBy('-date_activate')" :class="{ activeSpan: activeSort == 3 }">Самые
                        новые</h3>
                    <h3 @click="activeSort = 4, sortBy('date_activate')" :class="{ activeSpan: activeSort == 4 }">Самые
                        старые
                    </h3>
                </div>
                ...
                <div class="filter__body" :class="{ activeFilt: filter }">
                    ...
                    <div>
                        ...
                        <div class="inputs">
                            <input type="number" name="min" id="min" placeholder="от" v-model="minPrice"
                                @input="applyFilters">
                            <img src="@/assets/img/filterline.svg" alt="">
                            <input type="number" name="max" id="max" placeholder="до" v-model="maxPrice"
                                @input="applyFilters">
                        </div>
                    </div>
                </div>
        ...
        <div class="catalog">
            <div class="catalog__item" v-for="item in catalog.results" :key="item.id">
                <img :src="pathUrl + '/api' + item.add_image" alt="">
                <h1>{{ item.name }}</h1>
