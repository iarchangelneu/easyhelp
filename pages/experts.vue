...
<script setup>
useSeoMeta({
    title: 'Каталог Исполнителей | EasyHelp',
    ogTitle: 'Каталог Исполнителей | EasyHelp',
    description: 'Каталог Исполнителей | EasyHelp',
    ogDescription: 'Каталог Исполнителей | EasyHelp',
})
</script>
